      ...
      <div style={{ maxWidth: 1360, margin: "0 auto" }}>
        <div
          ...
          style={{
            ...
            background: "linear-gradient(135deg, rgba(20, 20, 25, 0.6) 0%, rgba(10, 10, 12, 0.85) 100%)",
            backdropFilter: "blur(20px)",
            WebkitBackdropFilter: "blur(20px)",
            boxShadow: "0 24px 50px rgba(0, 0, 0, 0.6), inset 0 1px 1px rgba(255, 255, 255, 0.12)",
            padding: "3rem",
            gap: "3rem",
            alignItems: "center",
          }}
        >
          ...
          <div className="lg:col-span-5">
            <span className="section-label">Personalizados & Encomendas</span>
            <h2
              style={{
          ...
          <div className="lg:col-span-7" style={{ background: "rgba(255, 255, 255, 0.02)", border: "1px solid rgba(255, 255, 255, 0.06)", padding: "2rem", borderRadius: "1rem", backdropFilter: "blur(10px)", WebkitBackdropFilter: "blur(10px)", boxShadow: "0 8px 32px rgba(0, 0, 0, 0.25), inset 0 1px 0px rgba(255, 255, 255, 0.05)" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1.5rem", borderBottom: "1px solid var(--color-border)", paddingBottom: "1rem" }}>
              <span style={{ fontSize: "0.8rem", color: "#AEAEB2", fontWeight: 600, fontFamily: "var(--font-display)" }}>
                CANAL DE ATENDIMENTO
              </span>
              
              {isAdminOnline ? (
                <div style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: "rgba(16,185,129,0.1)", border: "1px solid rgba(16,185,129,0.2)", padding: "0.35rem 0.75rem", borderRadius: "2rem", color: "#10B981", fontSize: "0.78rem", fontWeight: 700 }}>
            ...
            {success ? (
              <div style={{ textAlign: "center", padding: "2rem 0" }}>
                ...
                <h3 style={{ fontFamily: "var(--font-display)", color: "#fff", fontSize: "1.3rem", fontWeight: 700, margin: "0 0 0.5rem" }}>
                  Mensagem Enviada!
                </h3>
                ...
                <button
                  ...
                  style={{ background: "transparent", border: "1px solid var(--color-border)", color: "#fff", padding: "0.5rem 1.2rem", borderRadius: "0.5rem", fontSize: "0.8rem", cursor: "pointer" }}
                >
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "1rem" }} className="grid grid-cols-1 sm:grid-cols-2">
                  <div>
                    <label style={{ display: "block", fontSize: "0.78rem", color: "#AEAEB2", marginBottom: "0.4rem", fontWeight: 500 }}>Seu Nome*</label>
                    <input
                      type="text"
                      required
                      value={formData.name}
                      ...
                      style={{ width: "100%", background: "rgba(255, 255, 255, 0.03)", border: "1px solid rgba(255, 255, 255, 0.08)", borderRadius: "0.5rem", padding: "0.6rem 0.8rem", color: "#fff", fontSize: "0.85rem", transition: "all 0.2s" }}
                      className="focus:border-[var(--color-accent)] focus:bg-[rgba(255,255,255,0.06)] focus:outline-none"
                    />
                  </div>
                  <div>
                    <label style={{ display: "block", fontSize: "0.78rem", color: "#AEAEB2", marginBottom: "0.4rem", fontWeight: 500 }}>Seu E-mail*</label>
                    <input
                      type="email"
                      required
                ...
                <div>
                  <label style={{ display: "block", fontSize: "0.78rem", color: "#AEAEB2", marginBottom: "0.4rem", fontWeight: 500 }}>WhatsApp (Opcional)</label>
                  <input
                    type="tel"
                ...
                <div>
                  <label style={{ display: "block", fontSize: "0.78rem", color: "#AEAEB2", marginBottom: "0.4rem", fontWeight: 500 }}>Mensagem / Orçamento personalizado*</label>
                  <textarea
                    rows={4}
                    required
                    value={formData.messageText}
                    onChange={e => setFormData({ ...formData, messageText: e.target.value })}
                    placeholder="Diga-nos o que você deseja criar! Ex: Gostaria de imprimir um busto de 15cm do Darth Vader em filamento preto..."
                    style={{ width: "100%", background: "rgba(255, 255, 255, 0.03)", border: "1px solid rgba(255, 255, 255, 0.08)", borderRadius: "0.5rem", padding: "0.6rem 0.8rem", color: "#fff", fontSize: "0.85rem", resize: "none", lineHeight: 1.45, transition: "all 0.2s" }}
                    className="focus:border-[var(--color-accent)] focus:bg-[rgba(255,255,255,0.06)] focus:outline-none"
                  />
                </div>
