...
export function AdminPanel({ onClose }: AdminPanelProps) {
  const [activeTab, setActiveTab] = useState<"products" | "shopee" | "whatsapp" | "general" | "messages">("products");
  const [products, setProducts] = useState<Product[]>([]);
  const [messages, setMessages] = useState<any[]>([]);
  const [settings, setSettings] = useState<AppSettings>({
    storeName: "InovaStudio",
    storeDescription: "Peças decorativas, colecionáveis e utilidades premium impressas em 3D de alta precisão.",
        ...
        <div style={{ width: "100%", maxWidth: "420px", background: "#13131F", border: "1px solid #1F1F2E", borderRadius: "1.25rem", padding: "2rem", boxShadow: "0 20px 40px rgba(0,0,0,0.5)" }}>
          <div style={{ textAlign: "center", marginBottom: "2rem" }}>
            ...
            <p style={{ color: "#AEAEB2", fontSize: "0.85rem", marginTop: "0.5rem" }}>
              Insira a senha de acesso para configurar a {settings.storeName || "InovaStudio"}
            </p>
          </div>
                  ...
                  {messages.length === 0 ? (
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                      {messages.map((msg) => {
                        ...
                        const waReplyUrl = cleanPhone ? `https://wa.me/${cleanPhone}?text=${encodeURIComponent(`Olá, ${msg.name}! Vi seu contato no formulário do site da InovaStudio sobre a mensagem: "${msg.messageText}". Como podemos te ajudar?`)}` : null;
                  ...
                  <form onSubmit={handleSaveSettings} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "1rem" }}>
                      <div>
                        ...
                        <input
                          ...
                          placeholder="https://t.me/inovastudio"
                          style={{ width: "100%", background: "#1A1A26", border: "1px solid #2B2B3D", borderRadius: "0.5rem", padding: "0.6rem 0.8rem", color: "#fff" }}
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="Olá! Quero tirar uma dúvida com a equipe da InovaStudio..."
                        style={{ width: "100%", background: "#1A1A26", border: "1px solid #2B2B3D", borderRadius: "0.5rem", padding: "0.6rem 0.8rem", color: "#fff", resize: "none" }}
                      />
                    </div>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "1rem" }} className="grid grid-cols-1 md:grid-cols-2">
                      <div>
                        ...
                        <input
                          ...
                          placeholder="contato@inovastudio3d.com.br"
                          style={{ width: "100%", background: "#1A1A26", border: "1px solid #2B2B3D", borderRadius: "0.5rem", padding: "0.6rem 0.8rem", color: "#fff" }}
                        />
                        <span style={{ fontSize: "0.68rem", color: "var(--color-fg-muted)", marginTop: "0.25rem", display: "block" }}>
